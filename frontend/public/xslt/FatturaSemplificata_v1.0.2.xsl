		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					#fattura-elettronica .grassettodestra { font-weight: bold; text-align: right;}
					#fattura-elettronica .grassettosinistra { font-weight: bold; text-align: left;}
					#fattura-elettronica .destra { text-align: right;}
					#fattura-elettronica .bordocellainf {border-bottom: 1px dotted #000;
													  ...
													  <div id="Dati-beni-servizio">
														...
														<xsl:if test="RiferimentoNormativo">
															<li>
																...
																<h5>
																	<span> Riepilogo tabellare<br/></span>													
																</h5>
																<ul>
																<li>
																...
																<table width="100%">
																	<tr>
																		...
																		<td width="10%" class= "destra">
																			Natura	
																		</td>
																		<td width="20%" class= "destra">
																			Imposta	
																		</td>
																		<td width="10%" class= "destra">
																			Aliquota IVA	
																		</td>
																		<td width="30%" class= "destra">
																			Importo	
																		</td>										
																	</tr>
																...
																<xsl:for-each select="DatiBeniServizi">
																				<xsl:if test="(position( )) > 1">											
																					<tr>
																						<td class="bordocellainf" colspan='7'>
																						</td>										
																					</tr>										
																				</xsl:if>
																	<tr>
																		<td class= "grassettosinistra">
																			<xsl:value-of select="Descrizione"/>											
																		</td>
																		<td class= "grassettodestra">												
																			<xsl:if test="Natura!=''">											
																				<xsl:value-of select="Natura"/>									
																			</xsl:if>
