          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="rounded-lg border border-gray-200 dark:border-gray-700 p-4">
              ...
              <ul class="space-y-1 text-xs text-gray-600 dark:text-gray-400">
                ...
                <li>• <strong class="text-gray-700 dark:text-gray-300">Ricerca per importo</strong>: digita un numero (es. 1.234,56) per cercare su totale e imponibile</li>
            ...
            <div class="rounded-lg border border-gray-200 dark:border-gray-700 p-4">
              <div class="flex items-center gap-2 mb-2">
                <span class="text-base">📋</span>
                <span class="text-xs font-semibold text-gray-800 dark:text-white">Legenda codici</span>
              </div>
              <ul class="space-y-1 text-xs text-gray-600 dark:text-gray-400">
                <li>• Tabella con tutti i codici <strong class="text-gray-700 dark:text-gray-300">TD</strong> (tipo documento), <strong class="text-gray-700 dark:text-gray-300">MP</strong> (modalità pagamento) e <strong class="text-gray-700 dark:text-gray-300">TP</strong> (condizioni pagamento)</li>
                <li>• Accessibile dall'icona nella toolbar</li>
              </ul>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 dark:border-gray-700 p-4">
              <div class="flex items-center gap-2 mb-2">
                <span class="text-base">📝</span>
                <span class="text-xs font-semibold text-gray-800 dark:text-white">Novità e aggiornamenti</span>
              </div>
              <ul class="space-y-1 text-xs text-gray-600 dark:text-gray-400">
                <li>• Cronologia completa di tutte le versioni con badge per tipo</li>
                <li>• Accessibile dall'icona nella toolbar</li>
              </ul>
            </div>
